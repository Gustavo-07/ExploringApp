...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'tab3',
                loadChildren: () => Promise.all(/*! import() | tab3-tab3-module */[__webpack_require__.e("common"), __webpack_require__.e("tab3-tab3-module")]).then(__webpack_require__.bind(null, /*! ../tab3/tab3.module */ "./src/app/pages/tab3/tab3.module.ts")).then(m => m.Tab3PageModule)
            },
            {
                path: 'login',
            ...
            {
                path: 'mapa',
                loadChildren: () => __webpack_require__.e(/*! import() | mapa-mapa-module */ "mapa-mapa-module").then(__webpack_require__.bind(null, /*! ../mapa/mapa.module */ "./src/app/pages/mapa/mapa.module.ts")).then(m => m.MapaPageModule)
            },
            {
                path: 'ultimas-noticias',
                loadChildren: () => __webpack_require__.e(/*! import() | ultimas-noticias-ultimas-noticias-module */ "ultimas-noticias-ultimas-noticias-module").then(__webpack_require__.bind(null, /*! ../ultimas-noticias/ultimas-noticias.module */ "./src/app/pages/ultimas-noticias/ultimas-noticias.module.ts")).then(m => m.UltimasNoticiasPageModule)
            },
            {
                path: '',
